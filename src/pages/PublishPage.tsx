  ...
  return (
    <div className="rounded-2xl border p-6" style={{ backgroundColor: 'var(--color-card)', borderColor: 'var(--color-border)' }}>
      ...
      <form onSubmit={(e) => { e.preventDefault(); setError(''); publishMut.mutate(form); }} className="space-y-5">
        ...
        <button type="submit" disabled={publishMut.isPending} className="w-full py-3 rounded-lg text-xs mono font-semibold text-white transition-all hover:opacity-90 disabled:opacity-50" style={{ background: 'var(--color-accent)' }}>
        ...
        {mode === 'choose' && (
          <div className="grid gap-4">
            ...
            <button
              ...
              className="flex items-center gap-4 p-5 rounded-2xl border text-left transition-all hover:border-slate-500/40 hover:bg-violet-500/5 group"
            ...
            >
              ...
              <div className="flex-1">
                <div className="mono font-semibold text-white text-sm mb-1 group-hover:opacity-80 transition-colors">CREATE_NEW_MEMORY</div>
